    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(
                      ...
                      "~/Scripts/respond.js"));
            bundles.Add(new ScriptBundle("~/bundles/boostrapvalidator").Include("~/Scripts/bootstrapValidator.min.js"));
            bundles.Add(new ScriptBundle("~/bundles/screenvalidation").Include( "~/Scripts/screenValidation.js"));
